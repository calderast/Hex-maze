...
See the full [port_learning README](port_learning/README.md) for detailed docs on all models,
methods, and code examples.

| Model | Key idea | Free parameters |
| --- | --- | --- |
| **RescorlaWagner** | Delta-rule: Q ← Q + α·(reward − Q) | `alpha`, `decay` |
| **BayesianPortLearner** | Beta posterior per port | `prior_strength`, `decay` |
...
See [Tutorial 41](../../../Tutorials/41_Hex_Value_Learning.ipynb) for worked examples with
visualizations.
